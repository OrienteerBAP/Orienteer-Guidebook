...
* **Over Size** is the factor that sets the extra free storage space for documents. E.g. value 2 will spare free storage space for documents twice as large as their current space. This parameter can be used for performance optimization.
