...
To create a class, on the schema page ([..]/schema), on the **Classes** tab, click ![+ Create](Create.png). You will be guided to new class creation page. Enter required configuration and click **Save**
